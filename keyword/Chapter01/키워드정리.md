...
- Android의 Architecture
    - 안드로이드의 권장 아키텍쳐는 무엇일까요?
        ...
        **일반 아키텍쳐 원칙을 따르며 UI 레이어와 데이터 레이어 포함된 구조**
        ...
        ![image.png](Chapter01\images\Architecure.png)
    ...
    ![image.png](Chapter01\images\AAC.png)
...
- Manifest의 4대 컴포넌트
    - **액티비티 (activity)**
        ...
        ![image.png](Chapter01\images\Activity.png)
    ...
    - **콘텐트 제공자 (Content Provider)**
        ...
        **`Content Provider`** 는 ****파일 시스템, SQLite 데이터베이스, 웹, 기타 영구 저장소 내 데이터를 앱에서 액세스할 수 있고, 공유된 앱 데이터 집합을 관리한다. 
        ...
        ![image.png](Chapter01\images\ContentProvider.png)
...
- Android Layout
    ...
    4. RecyclerView
        ...
        **여러 데이터를 아이템 단위로 구성해 출력하는 ViewGroup**
        ...
        ![image.png](Chapter01\images\RecyclerView.png)
    ...
    5. ScrollView
        ...
        ![image.png](Chapter01\images\ScrollView.png)
    ...
    7. BottomNavigationView
        ...
        **화면 밑에 있는 네비게이션 역할을 하는 버튼 모음**
        ...
        ![image.jpg](Chapter01\images\BottomNavigation.jpg)
    ...
    10. margin
        ...
        ![image.png](Chapter01\images\Margin.png)
    ...
    12. chainStyle
        ...
        ![image.png](Chapter01\images\chainStyle.png)
